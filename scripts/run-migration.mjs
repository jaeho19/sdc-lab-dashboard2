...
async function runMigration() {
  const migrationPath = join(__dirname, '..', 'supabase', 'migrations', '00008_add_weekly_goals_timeline.sql');
  const sql = readFileSync(migrationPath, 'utf-8');

  console.log('Running migration: 00008_add_weekly_goals_timeline.sql\n');
